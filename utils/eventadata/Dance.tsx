    ...
    <div className="bg-cover bg-fixed bg-center">
      {mockData.length > 0 ? (
        mockData.map((item, index) => (
          ...
          >
            <div className="relative inline-block w-max text-center font-AnotherFont text-3xl [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))] md:text-4xl lg:text-5xl">
              <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat py-3 text-center text-5xl text-orange-500 text-transparent [text-shadow:0_0_rgba(0,0,0,0.1)] md:text-6xl lg:text-7xl">
                {item.eventname}
              </div>
