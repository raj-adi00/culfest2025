...
style={{backgroundColor:"rgba(0,0,0,0.4)"}}>
...

  {
    ...
    category: "Quizzing",
    description: "It is a quizzing event under Culfest'25,the cultural fest hosted by NITJSR (QuNITE).The event aims to test participants knowledge in various fields reflecting the theme of Culfest'25. It includes interconnected wordly things , geography , common history & food, etc.",
    image: "/qor.jpg",
    rules: (<>
      <div 
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
    1. Teams are expected to adhere to the principles of fair play and sportsmanship.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<p className="p-2 border-2 rounded-lg mt-2 font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]" style={{backgroundColor: "rgba(0,0,0,0.6)"}}>
...

  {
    ...
    category: "Dance",
    description:
      `"GREAT DANCERS ARE NOT GREAT BECAUSE OF THEIR TECHNIQUE,IT'S BECAUSE OF THEIR PASSION." It doesn't matter if you are a jazz dancer or a "Chak de Phatte" bhangra specialist.Put your dancing shoes on and compete in the solo dance competiton to prove that you are a connoisseur when it comes to grooving to beats.`,
    image: "/dance1.webp",
    rules: (
      <>
       <div 
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 It is a team event. A team must consist of 2 members only, 1 model and 1 designer. The event is open to individuals or teams (if specified) of all skill levels, from beginners to experienced designers. All designs should be original and reflect creativity, skill, and innovation. Plagiarism of designs is strictly prohibited. 
 </p>
</div>
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 It is a team event. A team must consist of minimum 12 models and maximum up to 18 models. A team must have a minimum of 4 boys or 4 girls. All the members should be dressed according to the theme given. 
 </p>
</div>
...
<p className="p-2 border-2 rounded-lg mt-2 font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]" style={{backgroundColor: "rgba(0,0,0,0.4)"}}>
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 o Write an editorial-style article on the topic or create a video on the same:<b>"Impact of Western TV shows on Indian youth"</b>
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  o The write-up/video can be either in English or Hindi. 
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 o The chosen language in prelims will remain the language of reporting throughout the competition if selected for the finals.
 </p>
</div>
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 o Video clippings must be submitted day-wise to the coordinator before 6 PM. 
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
    2. Equipment must be handled carefully; any damage will be penalized.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 This will be an abstract submission round .Participants need to write an abstract on the topic: We create our own devils Word limit: 250 words. The submission must be mailed to gensec.lds@nitjsr.ac.in. 
 </p>
</div>
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 16 people from the prelims will head to the finals It will be a JAM session with all the standard rules . 
 </p>
</div>
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 Normal JAM marking based on the number of errors committed by the speaker, number of minutes spoken , number of errors pointed will be considered while judging .
 </p>
</div>
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
1 .Initial Shortlisting of the participants will be done on
the basis of an abstract submission round.<br></br>
2. Participants need to submit an abstract on the topic: "AI a friend or enemy".(Word Limit : 250 Words)<br></br>
3. The submission must be mailed to gensec.lds@nitjsr.ac.in.<br></br>
4. Only individual participation is allowed. <br></br>
5. The event will consist of 3 rounds – Extempore, Turncoat Debate, Oxford Union-Style Debate.<br></br>
6. The topic or the prompt for extempore will be given on spot.<br></br>
7. The participant will be given 2-3 mins to think and 1-2 mins to speak on it.This will be an eliminating round. The qualifying participants will move on to the next round.<br></br>
8. Participants will be given a motion, and they will have to speak both for and against it in the turncoat round. Only two people will move on to the finals. <br></br> 
9 .The last round will be an Oxford Union debate where the two finalists will participate ina battle of wits. 
 </p>
</div>
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 1.The time limit for the performance, including the
time allotted for sound check is 10 minutes (Stage
in and stage out).
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 2 . The team should comprise 3 members including
 one as a vocalist.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 3. Teams must bring their own musical instruments.
 Drums are not allowed for the performance.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
4. No pre-recorded audio or midi interfaces are
allowed. However, teams can use looper pedals for
live looping.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
5. All original compositions must have their lyrics
printed/ written.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
6.There is no restriction of the language of the song.
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
7.Decision of the judges and the organising team will
be final and abiding.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<div 
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 1.Participants can sing eastern songs of any genre
 (preferably hindi).
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 ...
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
 3. They will need to carry a proper karaoke track or
 Instrument for their performances (compulsory).
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
4. Marks shall be deducted if the time limit is
exceeded.
 </p>
 <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<p className="p-2 border-2 rounded-lg mt-2 font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]" style={{backgroundColor: "rgba(0,0,0,0.4)"}}>
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  2. Players must follow suit if possible. If they cannot, they may play any card, including a trump card (spade).
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<p className="p-2 border-2 rounded-lg mt-2 font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]" style={{backgroundColor: "rgba(0,0,0,0.4)"}}>
...

  {
    ...
    category: "Informals",
    description:
      `A fun and interactive game where participants race to capture photos of specific items, scenes, or activities from a predefined list within a set time. It encourages creativity, teamwork, and exploration!`,
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  2. Each prompt will require teams to interpret, locate, and photograph
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  1. Teams will have a total of [specified time, e.g., 90 minutes] to complete
  the hunt.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<p className="p-2 border-2 rounded-lg mt-2 font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]" style={{backgroundColor: "rgba(0,0,0,0.4)"}}>
...

  {
    ...
    category: "Informals",
    description:
      `Compete in squads of 4 in this high-stakes BGMI tournament featuring 3 matches on Erangel, Sanhok, and Miramar. Earn points through kills and placement to climb the leaderboard, with cumulative scores deciding the winners. Play fair, join on time, and showcase your skills to dominate the battlegrounds!!`,
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  Each game features 100 players divided into 25 squads,
with each squad consisting of 4 players only.
  </p>
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  Matches will be played on Erangel, Sanhok, and Miramar (one match
    on each map).
  </p>
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  Final standings will be based on cumulative points earned
from kills and placement across all matches.
  </p>
</div>
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  2.Placement Points: Teams earn points based on their final rank in each match.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  3.Total Points: The sum of kill and placement points determines the final
  standing.
  </p>
</div>
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  2. Cheating, unauthorized software, or exploiting bugs will result in immediate
  disqualification.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  3. Conduct : Players must maintain sportsmanship and avoid toxic behavior
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  4. Match Integrity : Squads failing to join the lobby on time will forfeit their
  match.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  5. Penalties : Violations like team stacking, or unsportsmanlike conduct will
  result in penalties or disqualification.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  6. Registration Requirements : Each squad must register with exactly 4 players.
  </p>
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  1. One partner will be blindfolded and will have to apply makeup to the other
  partner.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  1. The right hand of both partners will be tied together with a ribbon.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  2. Using only their left hands, couples must cut out a given pattern from a page.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  3.Each team will be provided with a pattern and a pair of scissors.
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  4.The team that cuts out the perfect pattern within the time limit in Round 2
...
<p className="p-2 border-2 rounded-lg mt-2 font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]" style={{backgroundColor: "rgba(0,0,0,0.4)"}}>
...

  {
    ...
    category: "Informals",
    description:
      `A unique two-round event where teamwork, communication, and trust are key. Teams of two compete to showcase their coordination and navigation skills in a race against time. `,
    image: "/informal5.jpg",
    rules: (
      <>
  <div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  1. The adjacent legs of both team members (e.g., left leg of one and right leg  of the other) will be tied together.  
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  5.Top 10 teams with the fastest completion times qualify for the second round.    
  </p>
</div>
...
<div 
  ...
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  1. One team member will be the *Guide* (who can see the maze), while the other will be the *Runner* (who will be blindfolded).  
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  2.The Guide must navigate the blindfolded Runner verbally through the maze.   
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  3.Guide : Gives only verbal directions to the Runner.      
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  4.Runner : Blindfolded and must strictly follow the Guide’s instructions.     
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  5.Time Limit : Each team will get 10-15 minutes to complete the maze. Teams that fail to finish in this time will be disqualified.      
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  6.No Peeking : The Runner cannot see the maze at any point.        
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  7.No Physical Assistance : The Guide cannot physically assist the Runner in any way.  
  </p>
  <p className="font-serif text-[14px] text-white dark:text-white sm:text-3xl lg:text-3xl drop-shadow-[0_0_3px_black]">
  8. Winning : The team with the fastest time to complete the maze wins.  
  </p>
</div>
