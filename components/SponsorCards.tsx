...
function SponsorCards() {
  return (
    <div className=" w-full bg-grid-white/[0.3] bg-gray-900 reletive flex flex-col items-center justify-center overflow-hidden">
        <h2 className="text-4xl font-bold text-white text-center md-8 z-10">Our Proud Sponsors</h2>
