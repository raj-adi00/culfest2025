    ...
    return (
        <div className={styles.contactContainer}>
            <div className={styles.welcomeSection}>
                ...
                <p className={styles.welcomeText}>Join us for an unforgettable experience at <br /> NIT Jamshedpur. Celebrate culture, creativity, and <br />community with us.</p>
            </div>
            <div className={styles.contactDetailsSection}>
                ...
                <h2 className={styles.contactHeading}>Event Heads</h2>
                <p>John Doe - Event Coordinator</p>
                <p>Jane Smith - Cultural Committee Head</p>
            </div>
