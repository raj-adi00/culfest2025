            ...
            <div className="container mx-auto text-center">
              ...
              <section className="mt-16">
                ...
                <p className="text-lg leading-relaxed opacity-90">
                  ...
                  annually, it brings together participants from across the
                  globe to celebrate art, music, dance, and everything in
                  between. This is where budding artists find their stage,
                  creative minds find inspiration, and communities come together
                  to revel in the magic of culture.
                </p>
                <p className="mt-4 text-lg leading-relaxed opacity-90">
                  Over the years, Culfest has become a beacon of talent and
                  togetherness, featuring workshops, competitions, and
                  electrifying performances that captivate audiences of all
                  ages. Whether you're an artist, a performer, or simply someone
              ...
              <section className="mt-16 px-6 text-left">
                ...
                <p className="text-lg leading-relaxed opacity-90">
                  ...
                  captivating performances, and interactive workshops. Join us
                  to:
                </p>
                <ul className="mt-4 list-inside list-disc text-lg leading-relaxed opacity-90">
                  ...
                  <li>
                    Showcase your talent on a platform that celebrates
                    creativity.
                  </li>
                  <li>
              ...
              <section className="mt-12">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                  ...
                  <div className="rounded-lg bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 p-6 shadow-lg">
                    ...
                    <p>
                      Witness stunning art installations, participate in
                      creative workshops, and ignite your imagination.
                    </p>
                  </div>
                </div>
              </section>
