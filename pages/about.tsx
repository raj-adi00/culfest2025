...
const About: React.FC = () => {
  return (
    ...
    <a
      ...
      className="flex items-center justify-between  bg-gradient-to-r from-blue-800  via-blue-400 to-pink-500 text-white font-semibold px-6 py-4 rounded-lg shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl"
    >
      ...
      <svg
        ...
        strokeWidth="6"
        stroke="currentColor"
        className="w-auto h-4 animate-bounce"
      >
        <path
          strokeLinecap="round"
        ...
        />
          ...
          <div className="container mx-auto text-center">
            <h1 className="2 text-shadow-lg bg-gradient-to-r py-3 pb-4 from-yellow-400 via-orange-500 via-pink-500 to-red-500 bg-clip-text font-Pacifico text-5xl font-bold text-transparent">
