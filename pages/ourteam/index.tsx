  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore Our Team Page" />
      </Head>
      ...
      >
        {/* Navigation Menu */}
        <div className="w-full flex justify-center py mt-16">
        ...
        <div className="container relative z-0 mx-auto px-4 py-16">
          <motion.h1
            className="mb-16 text-center font-bold text-yellow-500 text-3xl sm:text-4xl md:text-5xl"
          ...
          {Object.entries(teamMembers).map(([section, members]) => (
            <motion.div
              ...
              animate="visible"
            >
              <motion.h2 className="mb-8 text-center text-2xl font-bold text-yellow-300 sm:text-3xl capitalize">
